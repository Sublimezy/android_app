...
public class PictureSelectionModel {
     ...
     * @param medias
     */
    public void openExternalPreview(int position, List<LocalMedia> medias,String action) {
        if (selector != null) {
            selector.externalPicturePreview(position, medias,
                    selectionConfig.windowAnimationStyle != null &&
                            selectionConfig.windowAnimationStyle.activityPreviewEnterAnimation != 0
                            ? selectionConfig.windowAnimationStyle.activityPreviewEnterAnimation : 0 ,action);
        } else {
            throw new NullPointerException("This PictureSelector is Null");
        }
    }
