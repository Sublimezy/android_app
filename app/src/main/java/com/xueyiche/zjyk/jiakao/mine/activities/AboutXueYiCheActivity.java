package com.xueyiche.zjyk.jiakao.mine.activities;
...
import com.xueyiche.zjyk.jiakao.constants.UrlActivity;


public class AboutXueYiCheActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        Intent intent = new Intent(AboutXueYiCheActivity.this,UrlActivity.class);
