 ...
 */
public class ZhuanXiangD extends BaseActivity {
    ...
    protected void initView() {
        ...
        mLV_zhuangxiang.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(App.context, ZhuangXiangDContent.class);
                switch (position) {
                    case 0:
    ...
    protected void initData() {
        ...
        leixing = new String[]{"时间", "距离", "速度", "标线", "标志", "手势", "信号灯", "酒驾", "灯光", "装置", "路况"};
        shuliang = new String[]{
                ...
                dbManager.getZhuangXiangNumber("1",leixing[10])};
