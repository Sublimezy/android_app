...
public class ZhuangXiangDContent extends BaseActivity implements View.OnClickListener{
    ...
    protected int initContentView() {
        ...
        allQuestionA = dbManager.getAllZhuangXiangQuestion("4",leixing);
            ...
            public void onPageSelected(int position) {
                ...
                ck_collection.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if (isChecked) {
                            db.add(qid, question, answer_1, answer_2, answer_3, answer_4, true_answer, explain, question_type, img,video, "shoucangf");
    ...
    private void initViewPager() {
        adapter = new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, final int position) {
                ...
                //确认答案
                Button mBT_affirm_answer = (Button) view.findViewById(R.id.bt_affirm_answer);
                //问题的视频与图片
                ...
                if (a_state!="1"||b_state!="1"||c_state!="1"||d_state!="1"){
                    ...
                    mCB_c.setClickable(false);
                    mCB_d.setClickable(false);
    ...
    protected void onPause() {
        super.onPause();
        int currentItem = readerViewPager.getCurrentItem();
        PrefUtils.putInt(App.context, leixing+"D", currentItem);
    }

    @Override
    protected void onStart() {
        super.onStart();
        int currentitem = PrefUtils.getInt(App.context, leixing+"D", 0);
