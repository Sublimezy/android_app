package com.xueyiche.zjyk.xueyiche.main.view;
...
public class SimpleButton extends View {
    ...
    private void _init(Context context, AttributeSet attrs) {
        mBorderWidth = AppUtils.dp2px(context, 0.5f);
        mRadius = AppUtils.dp2px(context, 5f);
        mHorizontalPadding = (int) AppUtils.dp2px(context, 5f);
        mVerticalPadding = (int) AppUtils.dp2px(context, 5f);
        mIconPadding = (int) AppUtils.dp2px(context, 3f);
        mTextSize = AppUtils.sp2px(context, 14f);
