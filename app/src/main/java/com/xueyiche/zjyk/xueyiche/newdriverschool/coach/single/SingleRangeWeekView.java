package com.xueyiche.zjyk.xueyiche.newdriverschool.coach.single;
...
public class SingleRangeWeekView extends WeekView {

    private int mRadius;

    public SingleRangeWeekView(Context context) {
        super(context);
//        //兼容硬件加速无效的代码
