 ...
 */
public class NormalGridImageAdapter extends
        RecyclerView.Adapter<NormalGridImageAdapter.ViewHolder> {
    ...
    public NormalGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
        this.mInflater = LayoutInflater.from(context);
        this.mOnAddPicClickListener = mOnAddPicClickListener;
    }

    public NormalGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener, int addPicRes) {
        this.mInflater = LayoutInflater.from(context);
        this.mOnAddPicClickListener = mOnAddPicClickListener;
