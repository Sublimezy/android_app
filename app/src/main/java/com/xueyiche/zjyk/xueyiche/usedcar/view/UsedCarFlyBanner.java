 ...
 */
public class UsedCarFlyBanner extends RelativeLayout {
    ...
    public UsedCarFlyBanner(Context context) {
        this(context, null);
    }

    public UsedCarFlyBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UsedCarFlyBanner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private class FlyPageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            final int newposition = position % mImageUrls.size();
