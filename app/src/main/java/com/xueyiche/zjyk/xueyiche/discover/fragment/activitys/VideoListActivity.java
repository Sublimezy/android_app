...
public class VideoListActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        tv_login_back.setText("视频");
        rv_shipin = (RecyclerView) view.findViewById(R.id.rv_shipin);
        rv_shipin.setLayoutManager(new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL));
        ...
        public void onBindViewHolder(ViewHolder holder, final int position) {
            if (list != null) {
                ...
                if (contentBean != null) {
                    ...
                    String is_praise = contentBean.getIs_praise();
