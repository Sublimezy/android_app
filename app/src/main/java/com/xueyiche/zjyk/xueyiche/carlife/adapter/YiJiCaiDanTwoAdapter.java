 ...
 */
public class YiJiCaiDanTwoAdapter extends BaseAdapter{
    private Context context;
    private List<SelectRegionsListBean.ContentBean> carType;
    ...
    public YiJiCaiDanTwoAdapter(Context context, List<SelectRegionsListBean.ContentBean> carType) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        cheliang_leixing.setText(carType.get(position).getArea_name());
