 ...
 */
public class DrivingRouteOverlayXian extends OverlayManager{
     ...
     */
    public DrivingRouteOverlayXian(BaiduMap baiduMap) {
        super(baiduMap);
    }
    public DrivingRouteOverlayXian(BaiduMap baiduMap, int size) {
        super(baiduMap);
        stationsize=size;
    }
    @Override
...
//        }
        ...
        if (mRouteLine.getStarting() != null) {
            overlayOptionses.add((new MarkerOptions())
                    ...
                    .icon(getStartMarker() != null ? getStartMarker():BitmapDescriptorFactory.fromAssetWithDpi("Icon_start.png")).visible(false).zIndex(0));
        }
                    ...
                    .add((new MarkerOptions())
                            ...
                            .icon(getTerminalMarker() != null ? getTerminalMarker() :
                                    BitmapDescriptorFactory
                                            .fromAssetWithDpi("Icon_end.png")).visible(false)
...
//            }
    ...
    public BitmapDescriptor getTerminalMarker() {
        BitmapDescriptor bitmap = BitmapDescriptorFactory.fromResource(R.mipmap.zhong_pic);
        return bitmap;
    }
