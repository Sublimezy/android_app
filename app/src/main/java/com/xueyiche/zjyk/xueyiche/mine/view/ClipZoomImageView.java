...

{
    ...
    //已修改
    private float clipFlag ;

    //已修改
    public void setClipFlag(float clipFlag) {
...
//			mVerticalPadding = (getHeight() - (getWidth() - 2 * mHorizontalPadding)) / 2;
            mVerticalPadding = (int) ((getHeight() - (getWidth() - 2 * mHorizontalPadding)*clipFlag) / 2);
    ...
    public Bitmap clip()
    {
        ...
        return Bitmap.createBitmap(bitmap, mHorizontalPadding,
                ...
                (int) ((getWidth() - 2 * mHorizontalPadding)*clipFlag));
//		return Bitmap.createBitmap(bitmap, mHorizontalPadding,
//				mVerticalPadding, getWidth() - 2 * mHorizontalPadding,
