...
import com.xueyiche.zjyk.xueyiche.usedcar.utils.UsedCarDialogUtils;
...
public class BasePickerView {
    ...
    public Animation getInAnimation() {
        int res = UsedCarDialogUtils.getAnimationResource(this.gravity, true);
        return AnimationUtils.loadAnimation(context, res);
    }

    public Animation getOutAnimation() {
        int res = UsedCarDialogUtils.getAnimationResource(this.gravity, false);
        return AnimationUtils.loadAnimation(context, res);
    }
