package com.xueyiche.zjyk.xueyiche.daijia.view;
 ...
 */
public class YuYueLinkagePicker extends WheelPicker {
    ...
    public YuYueLinkagePicker(Activity activity) {
        super(activity);
    }
     ...
     * 二级联动选择器构造函数
     */
    public YuYueLinkagePicker(Activity activity, ArrayList<String> firstList,
    ...
    protected View makeCenterView() {
        ...
        secondView.setOnWheelViewListener(new WheelView.OnWheelViewListener() {
            ...
            public void onSelected(boolean isUserScroll, int selectedIndex, String item) {
                ...
                ArrayList<String> thirdListItem = new ArrayList<>();
                ...
                if (selectedFirstIndex==0) {
                    if (selectedSecondIndex==0) {
                        thirdView.setItems(thirdList.get(selectedSecondIndex), 0);
                    }else {
                        thirdView.setItems(thirdListItem, 0);
                    }
                }else {
                    thirdView.setItems(thirdListItem, 0);
                }
