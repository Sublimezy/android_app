...
public class LeftAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (flagArray.get(position)) {
            holder.lv_left_item_text.setBackgroundColor(Color.parseColor("#ff5000"));
            holder.lv_left_item_text.setTextColor(Color.WHITE);

        } else {
            holder.lv_left_item_text.setBackgroundColor(Color.parseColor("#ffffff"));
            holder.lv_left_item_text.setTextColor(Color.parseColor("#323232"));
