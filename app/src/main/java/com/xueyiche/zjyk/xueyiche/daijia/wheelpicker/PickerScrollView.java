 ...
 * @ClassName: PickerScrollView
 * @Description: java类作用描述
 * @Author: 松鼠爱吃肉
 * @CreateDate: 2021/4/21 8:39
 */
public class PickerScrollView extends View {
    ...
    private List<PickerList> mDataList;
    /**
    ...
    private void performSelect() {
        ...
        picker = mDataList.get(mCurrentSelected);
    }

    private PickerList picker;

    public PickerList getSelectedPicker() {
        if (picker == null) {
            picker = mDataList.get(mCurrentSelected);
        }
        return picker;
    ...
    public void setData(List<PickerList> datas) {
        mDataList = datas;
    ...
    private void moveHeadToTail() {
        PickerList datasBean = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(datasBean);
    }

    private void moveTailToHead() {
        PickerList datasBean = mDataList.get(mDataList.size() - 1);
    ...
    private int selectedTextColor = 0xFF6FB3;
    ...
    private void drawData(Canvas canvas) {
        ...
        String textData = mDataList.get(indexs).getName();
    ...
    public interface onSelectListener {
        void onSelect(PickerList pickers);
    }
