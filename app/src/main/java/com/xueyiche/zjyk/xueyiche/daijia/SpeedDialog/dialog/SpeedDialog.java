package com.xueyiche.zjyk.xueyiche.daijia.SpeedDialog.dialog;
...
import com.xueyiche.zjyk.xueyiche.daijia.SpeedDialog.adapter.BottomDialogAdapter;
import com.xueyiche.zjyk.xueyiche.daijia.SpeedDialog.listener.OnInputDialogButtonClickListener;
import com.xueyiche.zjyk.xueyiche.daijia.SpeedDialog.listener.OnMenuItemClickListener;
import com.xueyiche.zjyk.xueyiche.daijia.SpeedDialog.listener.OnSelectClickListener;
...
public class SpeedDialog extends Dialog implements View.OnClickListener {
    ...
    public SpeedDialog(Context context, int dialogType) {
        super(context, R.style.MyDialog2);   //设置自己的风格
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mDialogType == BOTTOM_SELECT_TYPE) {
            ...
            mInputEdit.setInputType(mInputType);
        ...
        if (i == R.id.dialogCancelBtn || i == R.id.cancelBtn) {
            ...
            if (mDialogType == INPUT_TYPE) {
                if (mInputDialogSureClickListener != null)
                    mInputDialogSureClickListener.onClick(this, mInputEdit.getText().toString().trim());
            } else {
    ...
    public SpeedDialog setHint(String hint) {
        ...
        if (!TextUtils.isEmpty(hint) && mInputEdit != null) {
    ...
    public SpeedDialog setMenuNameList(List<String> menuNameList) {
        ...
        if (mMenuNameList != null && mBottomRecyclerView != null) {
            if (mBottomDialogAdapter == null)
                mBottomDialogAdapter = new BottomDialogAdapter(mMenuNameList);
     ...
     * @return
     */
    public SpeedDialog setInputType(int inputType) {
