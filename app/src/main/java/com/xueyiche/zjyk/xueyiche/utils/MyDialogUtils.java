 ...
 * @ClassName: MyDialogUtils
 * @Description: java类作用描述
 * @Author: 松鼠爱吃肉
 * @CreateDate: 2020/7/27 13:53
 */
public class MyDialogUtils extends Dialog {
    ...
    public MyDialogUtils(Context context, int theme) {
        super(context, theme);
    }
...
//    }
    ...
    public static class Builder {
        ...
        public MyDialogUtils.Builder setCancelable(boolean cancelable) {
            this.mCancelable = cancelable;
            return this;
        }
        ...
        public MyDialogUtils create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final MyDialogUtils dialog = new MyDialogUtils(context, R.style.MyDialog);
