...
public class SubjectDQuestion extends BaseActivity {
    ...
    private List<Questiond> allQuestionD;
    private KaoJiaZhaoDao db;
    private List<Questiona> allShouCang;
    ...
    protected int initContentView() {
        ...
        allQuestionD = dbManager.getAllQuestionD();
    ...
    protected void initView() {
        ...
        mTV_title_mun.setText(1 + "/" + allQuestionD.size());
        mLL_questionback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                ExamActivity activity = new ExamActivity();
//                Intent intent = new Intent().putExtra("position", 3);
//                activity.setDefaultFragment(intent);
                finish();
            }
        });
        initViewPager();
    ...
    protected void initListener() {
        readerViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                final Questiond questiond = allQuestionD.get(position);
                ...
                mTV_title_mun.setText(timu_qid + "/" + allQuestionD.size());
        ...
        adapter = new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, final int position) {
                ...
                if (video != null&& !TextUtils.isEmpty(video)) {
                    ...
                    mVV_kemu4.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                int timu_qid = position + 1;
                mTV_qusetion.setText(timu_qid + "/" + allQuestionD.size());
    ...
    protected void onPause() {
        super.onPause();
        int currentItem = readerViewPager.getCurrentItem();
        PrefUtils.putInt(App.context, "CURRENTITEM4", currentItem);
        int daTJL = currentItem + 1;
        PrefUtils.putString(App.context,"four_number",daTJL+"");
        db.daTJLD(daTJL + "");
    }
    ...
    protected void onStart() {
        super.onStart();
        int currentitem = PrefUtils.getInt(App.context, "CURRENTITEM4", 0);
