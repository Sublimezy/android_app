...
import com.xueyiche.zjyk.xueyiche.homepage.bean.Questiond;
...
DBManager {
    ...
    public List<Questiona> getAllQuestionA() {
        ...
        while (cursor.moveToNext()) {
            ...
            String qid = cursor.getString(cursor.getColumnIndex("number"));
            ...
            String question_type = cursor.getString(cursor.getColumnIndex("type"));
            que = new Questiona();
    ...
    public List<Questiona> answerWithCashQuestion() {
        ...
        while (cursor1.moveToNext()) {
            String question = cursor1.getString(cursor1.getColumnIndex("question"));
            String answer_1 = cursor1.getString(cursor1.getColumnIndex("answer1"));
            String answer_2 = cursor1.getString(cursor1.getColumnIndex("answer2"));
            String answer_3 = cursor1.getString(cursor1.getColumnIndex("answer3"));
            String answer_4 = cursor1.getString(cursor1.getColumnIndex("answer4"));
            String qid = cursor1.getString(cursor1.getColumnIndex("number"));
            String img = cursor1.getString(cursor1.getColumnIndex("image"));
            String video = cursor1.getString(cursor1.getColumnIndex("video"));
            String true_answer = cursor1.getString(cursor1.getColumnIndex("true_answer"));
            String explain = cursor1.getString(cursor1.getColumnIndex("explain"));
            String question_type = cursor1.getString(cursor1.getColumnIndex("type"));
            que = new Questiona();
            que.setQuestion(question);
            que.setAnswer_1(answer_1);
            que.setAnswer_2(answer_2);
