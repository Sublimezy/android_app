package com.gxuwz.zy.exam.activity.question;

import static com.gxuwz.zy.constants.Constant.ALL_TIME;
import static com.gxuwz.zy.constants.Constant.ALL_TIME_MIN;
import static com.gxuwz.zy.constants.Constant.DEF_QUESTION_TYPE;
import static com.gxuwz.zy.constants.Constant.DEF_SUBJECT;
import static com.gxuwz.zy.constants.Constant.MISTAKES_NUM;
import static com.gxuwz.zy.constants.Constant.ONCE_TIME;
...
import static com.gxuwz.zy.constants.Constant.SUBJECT1_NUM;
import static com.gxuwz.zy.constants.Constant.SUBJECT4_NUM;
...
import com.gxuwz.zy.exam.activity.practice.PracticeEndActivity;
import com.gxuwz.zy.exam.adapter.question.QuestionAdapter;
...
import com.gxuwz.zy.exam.fragment.question.QuestionFragment;
import com.gxuwz.zy.utils.PrefUtils;
import com.gxuwz.zy.view.ReaderViewPager;
...
//                ToastUtils.showToast(this, "收藏成功id为" + questionBean.getId());
                ...
                ToastUtils.showToast(this, "已移除该收藏");
                ckCollection.setText("收藏");
//                ToastUtils.showToast(this, "移除收藏id为" + questionBean.getId());

            }
            PrefUtils.putStrListValue(this, PRE_COLLECT, collect);
            ...
            args.putInt(UN_ANSWERED_NUM, myGradeBean.getUnAnsweredNum());
            args.putInt(TAKE_TIME, myGradeBean.getTakeTime());
            args.putInt(SCORE, myGradeBean.getScore());
            args.putInt(MISTAKES_NUM, myGradeBean.getMistakesNum());
